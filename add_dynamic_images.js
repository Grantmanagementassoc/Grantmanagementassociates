...
function updateDynamicPage(pagePath, typeName) {
    ...
    const replace = search + `\n        {${typeName}.image && (\n          <Image src={${typeName}.image} alt="Background" fill className="object-cover opacity-10 absolute inset-0 z-[-1] pointer-events-none mix-blend-luminosity" priority />\n        )}`;
...
updateDynamicPage('src/app/services/[slug]/page.tsx', 'service');
updateDynamicPage('src/app/industries/[slug]/page.tsx', 'industry');
