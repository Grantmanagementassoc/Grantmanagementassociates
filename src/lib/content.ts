...
export const results: CaseStudy[] = [
  ...
  },
  {
    ...
    year: 2024,
    type: "Federal",
    agency: "Market innovations are needed to compensate underserved, small-acreage landowners for the public benefits of harvest deferral. The Sky Harvest Landowner Access Project uses a new carbon methodology that addresses landowners' needs while creating a more valuable credit to buyers.",
