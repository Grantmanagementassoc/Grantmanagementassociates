    ...
    <>
      <section className="relative pt-32 pb-12 md:pt-40 md:pb-16 overflow-hidden noise">
        ...
        <div className="relative mx-auto max-w-4xl px-6">
          ...
          <h1 className="mt-4 text-4xl md:text-6xl font-semibold text-foreground leading-[1.02]">{role.title}</h1>
          <div className="mt-4 flex flex-wrap gap-2">
            <span className="text-xs px-2.5 py-1 rounded-full border border-glass-border bg-black/5 dark:bg-white/5 text-muted">{role.location}</span>
            <span className="text-xs px-2.5 py-1 rounded-full border border-glass-border bg-black/5 dark:bg-white/5 text-muted">{role.type}</span>
          </div>
        </div>
      </section>
