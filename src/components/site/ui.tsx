...
export function GlassCard({
  ...
  return (
    <ScrollReveal animation="scale-up" random={true} className="h-full flex flex-col">
      <div
        className={`glass rounded-2xl p-6 h-full flex flex-col flex-grow ${hover ? "card-hover" : ""} ${className}`}
      >
        {children}
      </div>
    </ScrollReveal>
