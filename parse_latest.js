...
async function parseDoc() {
    const docPath = path.join(__dirname, '../GMA_Weekly_Funding_Digest_Sept_7_11_2026.docx');
    console.log("Reading doc:", docPath);
    ...
    const outPath = path.join(__dirname, 'src/data/newsletters/sept-7-11-2026.json');
    fs.writeFileSync(outPath, JSON.stringify(results, null, 2));
    console.log('Saved to ' + outPath);
}

parseDoc().catch(console.error);
